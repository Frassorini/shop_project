...
class ResourceSnapshot:
    def __init__(self, 
                 snapshotset_vector: dict[Type[PersistableEntity], EntitySnapshotSet]
                 ) -> None:
        self.snapshot_set_vector: dict[Type[PersistableEntity], EntitySnapshotSet] = snapshotset_vector
