...
class RepositoryContainer:
    ...
    def load_from_query(self, query: LoadQuery) -> list[PAggregate]:
    ...
    def save(self, resource_changes_snapshot: dict[Type[PAggregate], dict[Literal['CREATED', 'UPDATED', 'DELETED'], list[dict[str, str]]]]) -> None:
