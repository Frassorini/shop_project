...
def test_not_eq_different_classes() -> None:
    ...
    obj_1 = ExampleDomainClass1(uuid_id)

    obj_2 = ExampleDomainClass2(uuid_id)
...
def test_eq() -> None:
    ...
    obj_2 = ExampleDomainClass1(uuid_id)
...
def test_not_eq() -> None:
    ...
    obj_1 = ExampleDomainClass1(uuid_id_1)

    obj_2 = ExampleDomainClass1(uuid_id_2)
